...
class ProjectCreateTestCase(TestCase):
    ...
    def test_create_project(self):
        ...
        response = client.post('/project/detail', {
            ...
            "end_datetime":"2019-12-5 18:00:00",
	        "jobs":'''[{
				    "job_name":"job1", 
				    "job_worktime":2.5, 
...
class ProjectTestCase(TestCase):
    def setUp(self):
        ...
        _project = Project.objects.create(id=1, webuser=admin1, title='test', content='testcontent', requirements='req', deadline=datetime.datetime(2019,12,1,23,59,59),
            begin_datetime=datetime.datetime(2019,12,4,0,0,0), end_datetime=datetime.datetime(2019,12,5,23,59,59)) 
...
class signprojectTestCase(TestCase):
    ...
    def setUp(self):
        ...
        _project = Project.objects.create(id=1, webuser=_webuser, title='test', content='testcontent', requirements='req', 
                deadline=datetime.datetime(2019,12,1,23,59,59), begin_datetime=datetime.datetime(2019,12,4,0,0,0), 
                end_datetime=datetime.datetime(2019,12,5,23,59,59))
...
class signinTestCase(TestCase):
    def setUp(self):
        ...
        _project = Project(id=1, webuser=_webuser, title='test', content='testcontent', requirements='req', begin_datetime=datetime.datetime(2019,12,4,0,0,0), 
                end_datetime=datetime.datetime(2019,12,5,23,59,59), deadline=datetime.datetime(2019,12,1,23,59,59))
        _project.save()
        _job = Job(id=1, project=_project, job_name='test_job', job_worktime=5.0, job_content='content_test', job_require_num=10)
        _job.save()
